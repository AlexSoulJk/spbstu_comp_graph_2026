	...
	ID3D11DeviceContext* pContext)
{
	...
	HRESULT hr = CompileShaderFromFile(L"ScreenPlane.vs", "main", "vs_5_0", &pVSBlob);
	if (FAILED(hr))
	{
		MessageBox(nullptr,
...
void ScreenPlane::Release() {
	...
	if (pProcessTextureLayout)
	{
		pProcessTextureLayout->Release();
		pProcessTextureLayout = nullptr;
	}
	if (pVertexShader)
	{
